    ...
    def _get_base_system_prompt_a(self) -> Dict[str, str]:
        ...
        return {
            ...
            "content": (
                ...
                "and open to refinement of your initial ideas. When confident in your reasoning, you may provide a conclusion with 'Final Answer: X'. IMPORTANT: When you see the "
    ...
    def _get_base_system_prompt_b(self) -> Dict[str, str]:
        ...
        return {
            ...
            "content": (
                ...
                "and development of ideas. When confident in your reasoning, you may provide a conclusion with 'Final Answer: X'. IMPORTANT: When you see the "
                "prompt '(final turn)', you MUST end your response with 'Final Answer: X', where X is your definitive conclusion. "
                "This is critical for evaluation purposes."
            )
        }